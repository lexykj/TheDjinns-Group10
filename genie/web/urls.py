...
urlpatterns = [
    ...
    path('lot_add_attendants/<int:parkingLot_id>', views.lot_add_attendants, name='lot_add_attendants'),
    path('lot_delete_attendants/<int:parkingLot_id>', views.lot_delete_attendants, name='lot_delete_attendants'),
    ...
    path('delete_lot/<int:parkingLot_id>', views.delete_lot, name='delete_lot'),
